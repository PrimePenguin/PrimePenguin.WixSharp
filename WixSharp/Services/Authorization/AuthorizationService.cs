...
namespace WixSharp.Services.Authorization
{
    public class AuthorizationService
    {
       ...
       /// <remarks>
        ...
        /// <param name="myWixUrl">The store's *.myWixUrl.com URL, which should be a parameter named 'shop' on the request querystring.</param>
        /// <param name="wixAppKey">Your app's public API key.</param>
        /// <param name="wixAppSecretKey">Your app's secret key.</param>
        /// <returns>The authorization result.</returns>
        public static async Task<WixAuthorizationResult> AuthorizeWithResult(string code, string myWixUrl,string wixAppKey, string wixAppSecretKey)
        {
            if (string.IsNullOrEmpty(myWixUrl)) myWixUrl = "www.wix.com";
            var ub = new UriBuilder(WixService.BuildShopUri(false, myWixUrl))
            {
                Path = "oauth/access"
            };
            ...
            using (var msg = new CloneableRequestMessage(ub.Uri, HttpMethod.Post, content))
            {
                ...
                return new WixAuthorizationResult(json.Value<string>("access_token"), json.Value<string>("refresh_token"));
            }
        }
        ...
        public static async Task<WixAuthorizationResult> Authorize(string code, string wixUrl, string wixAppKey, string wixAppSecretKey)
        {
            return (await AuthorizeWithResult(code, wixUrl, wixAppKey, wixAppSecretKey));
        }
        ...
        public static Uri BuildAuthorizationUrlUsingToken(string wixUrl,string wixAppId, string redirectUrl, string state = null)
        {
            ...
            var builder = new UriBuilder(WixService.BuildShopUri(false, wixUrl));
        ...
        {
            var ub = new UriBuilder(WixService.BuildShopUri(false, "www.wix.com"))
            {
                Path = "oauth/access"
            };
